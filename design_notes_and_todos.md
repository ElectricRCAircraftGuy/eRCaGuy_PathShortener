...
1. [ ] Or, possibly the problem is that I don't walk the copied dir, but rather, I walk the **pre-copied** dir? And yet once copied, the paths are much much different and longer since symlink dirs have now been copied as real dirs!?
1. [ ] Fix the bug. 
